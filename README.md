...
## ✅ Google AI Studio
This project was developed using Google AI Studio, which provides direct access to Gemini models through a browser-based API. All Gemini-powered features (HTML/Tailwind conversion, React generation, Flutter widgets, and React Native layout generation) are executed using Gemini models from AI Studio, without requiring any backend server.
